...
const ContactForm: React.FC = () => {
  return (
    <section className="flex overflow-hidden flex-col justify-center items-center py-24 w-full max-md:max-w-full">
      ...
      <div className="flex flex-col justify-center items-center mt-2.5 max-w-full w-[832px]">
        <form className="flex flex-wrap gap-10 justify-between px-3.5 py-3 w-full border border-gray-200 border-solid max-w-[832px] min-h-[86px] rounded-[50px] max-md:max-w-full">
