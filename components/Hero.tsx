  ...
  return (
    <section className="flex relative z-0 gap-10 justify-center items-start w-full min-h-[846px] text-neutral-900">
      ...
      <div className="flex relative z-0 flex-col items-start self-end text-2xl tracking-tight text-white min-w-[240px] w-[952px] max-md:max-w-full" >
        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/1391f202a6104b468a8033acf7e36115/4c7a02f13c0ede516ea9773df2b729ec4e74cacc7b0317d3a805fdec91371b14?apiKey=2c0ef7d7caa24d8d8c04d3962010fc58&" alt="Background design" className="object-contain absolute bottom-0 z-0 max-w-full aspect-[2] h-[356px] right-[57px] w-[812px]" />
        {/* <img loading="lazy" src="Hero1.png" alt="Hero image" className="image_off object-contain z-0 self-center max-w-full aspect-[1.5] w-[852px] h-full" /> */}
        <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/1391f202a6104b468a8033acf7e36115/e67f32d04f31e09a2650feaa59c8f05d98cf87c81242dd606a9cc80ff29dff52?apiKey=2c0ef7d7caa24d8d8c04d3962010fc58&" alt="Hero image" className=" object-contain z-0 self-center max-w-full aspect-[1.5] w-[852px]" />
      </div>
